...
function BottomFooter() {
  const services = [
    ...
    {
      service: "Cloud Enablement Services​",
      link: "/",
    },
    {
  ...
  return (
    <footer className="bg-[#0D0F1C] text-white dark:bg-gray-900 mt-20">
      <div className="mx-auto w-full container p-4 py-6 lg:py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-20 md:justify-between">
          <div className="mb-6 md:mb-0">
            <div className="grid grid-rows-1 gap-4 h-auto">
              ...
              <div className="flex justify-center md:justify-start text-center md:text-start">
                <p className="text-gray-400">
                  ...
                  us to identify problems your customers are facing, understand
                  them in great detail, and offer solutions that improve their
          ...
          <div className="">
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div className="text-center md:text-start">
                ...
                <ul className="dark:text-gray-400 text-gray-400 font-medium">
                  <li className="mb-4">
                    <a href="#" className="hover:underline ">
                      Github
                    </a>
